  ...
  return (
    <>
      <div className="App">
        ...
        <main>
          <PorfolioSection/>
          <h2>Lorem ipsum odor amet, consectetuer adipiscing elit. Ornare magna nam inceptos sollicitudin morbi tincidunt lacinia fusce. Varius penatibus posuere purus integer consectetur praesent. Varius malesuada sagittis ridiculus lacinia suspendisse diam morbi sociosqu adipiscing. Aliquam urna efficitur faucibus nibh id arcu ultricies interdum. Nostra sem egestas nisl tortor torquent habitasse.
