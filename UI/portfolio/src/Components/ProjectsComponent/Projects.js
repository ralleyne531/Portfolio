...
function Projects(){
    ...
    return(
        <>
            <h2>Projects</h2>
            <ProjectsDiv>
            <ProjectsCard project={"Portfolio"} creationDate={"April 2023"} stage={"New Planning"} iconNames={["HTMLIcon", "CSSIcon", "JSIcon", "ReactIcon"]}></ProjectsCard>
            ...
            <ProjectsCard project={"ElevateEatsAPI"} creationDate={"May 2024"} stage={"Development"} iconNames={["MongoIcon","JSIcon", "ExpressIcon"]}></ProjectsCard>
